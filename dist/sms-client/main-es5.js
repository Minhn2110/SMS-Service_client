...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppFeatureHomeHomeComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<div class=\"intro-banner\" data-background-image=\"https://wallpaperaccess.com/full/776490.jpg\">\n\t<div class=\"container\">\n\n\t\t<!-- Intro Headline -->\n\t\t<div class=\"row\">\n\t\t\t<div class=\"col-md-12\">\n\t\t\t\t<div class=\"banner-headline\">\n\t\t\t\t\t<h3>\n\t\t\t\t\t\t<strong>Send & Receive Messages Worldwide.</strong>\n\t\t\t\t\t\t<br>\n\t\t\t\t\t\t<br>\n\t\t\t\t\t\t<span>Business messaging made easy. Send thousands of text messages anywhere in the world with<strong\n\t\t\t\t\t\t\t\tclass=\"color\"> Online Services.</strong> Sign up and be sending from dashboard or API within\n\t\t\t\t\t\t\tminutes</span>\n\t\t\t\t\t</h3>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\n\t\t<!-- Stats -->\n\t\t<div class=\"row\">\n\t\t\t<div class=\"col-md-12\">\n\t\t\t\t<ul class=\"intro-stats margin-top-45 hide-under-992px\">\n\t\t\t\t\t<li>\n\t\t\t\t\t\t<strong class=\"counter\">1,586</strong>\n\t\t\t\t\t\t<span>Users</span>\n\t\t\t\t\t</li>\n\t\t\t\t\t<li>\n\t\t\t\t\t\t<strong class=\"counter\">3,543</strong>\n\t\t\t\t\t\t<span>Message sent</span>\n\t\t\t\t\t</li>\n\t\t\t\t</ul>\n\t\t\t</div>\n\t\t</div>\n\n\t</div>\n\t<div class=\"background-image-container\" style=\"background-image: url('https://wallpaperaccess.com/full/776490.jpg');\">\n\t</div>\n</div>\n<!-- Category Boxes -->\n<div class=\"section margin-top-65\">\n\t<div class=\"container\">\n\t\t<div class=\"row\">\n\t\t\t<div class=\"col-xl-12\">\n\n\t\t\t\t<div class=\"section-headline centered margin-bottom-15\">\n\t\t\t\t\t<h3>Popular Subscription Services</h3>\n\t\t\t\t</div>\n\n\t\t\t\t<!-- Category Boxes Container -->\n\t\t\t\t<div class=\"categories-container\">\n\n\t\t\t\t\t<!-- Category Box -->\n\t\t\t\t\t<a href=\"javascript:void(0)\" class=\"category-box\">\n\t\t\t\t\t\t<div class=\"category-box-icon\">\n\t\t\t\t\t\t\t<i class=\"icon-line-awesome-file-code-o\"></i>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"category-box-counter\">612</div>\n\t\t\t\t\t\t<div class=\"category-box-content\">\n\t\t\t\t\t\t\t<h3>Breaking News</h3>\n\t\t\t\t\t\t\t<p>Software Engineer, Web / Mobile Developer & More</p>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</a>\n\n\t\t\t\t\t<!-- Category Box -->\n\t\t\t\t\t<a href=\"javascript:void(0)\" class=\"category-box\">\n\t\t\t\t\t\t<div class=\"category-box-icon\">\n\t\t\t\t\t\t\t<i class=\"icon-line-awesome-cloud-upload\"></i>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"category-box-counter\">113</div>\n\t\t\t\t\t\t<div class=\"category-box-content\">\n\t\t\t\t\t\t\t<h3>Sport News</h3>\n\t\t\t\t\t\t\t<p>Data Specialist / Scientist, Data Analyst & More</p>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</a>\n\n\t\t\t\t\t<!-- Category Box -->\n\t\t\t\t\t<a href=\"javascript:void(0)\" class=\"category-box\">\n\t\t\t\t\t\t<div class=\"category-box-icon\">\n\t\t\t\t\t\t\t<i class=\"icon-line-awesome-suitcase\"></i>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"category-box-counter\">186</div>\n\t\t\t\t\t\t<div class=\"category-box-content\">\n\t\t\t\t\t\t\t<h3>Stock News</h3>\n\t\t\t\t\t\t\t<p>Auditor, Accountant, Fnancial Analyst & More</p>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</a>\n\n\t\t\t\t\t<!-- Category Box -->\n\t\t\t\t\t<a href=\"javascript:void(0)\" class=\"category-box\">\n\t\t\t\t\t\t<div class=\"category-box-icon\">\n\t\t\t\t\t\t\t<i class=\"icon-line-awesome-pencil\"></i>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"category-box-counter\">298</div>\n\t\t\t\t\t\t<div class=\"category-box-content\">\n\t\t\t\t\t\t\t<h3>COVID-19 News</h3>\n\t\t\t\t\t\t\t<p>Copywriter, Creative Writer, Translator & More</p>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</a>\n\t\t\t\t</div>\n\n\t\t\t</div>\n\t\t</div>\n\t</div>\n</div>\n<!-- Category Boxes / End -->\n\n\n<div class=\"section padding-top-65 padding-bottom-65\">\n\t<div class=\"container\">\n\t\t<div class=\"row\">\n\n\t\t\t<div class=\"col-xl-12\">\n\t\t\t\t<!-- Section Headline -->\n\t\t\t\t<div class=\"section-headline centered margin-top-0 margin-bottom-5\">\n\t\t\t\t\t<h3>How It Works?</h3>\n\t\t\t\t</div>\n\t\t\t</div>\n\n\t\t\t<div class=\"col-xl-4 col-md-4\">\n\t\t\t\t<!-- Icon Box -->\n\t\t\t\t<div class=\"icon-box with-line\">\n\t\t\t\t\t<!-- Icon -->\n\t\t\t\t\t<div class=\"icon-box-circle\">\n\t\t\t\t\t\t<div class=\"icon-box-circle-inner\">\n\t\t\t\t\t\t\t<i class=\"icon-line-awesome-lock\"></i>\n\t\t\t\t\t\t\t<div class=\"icon-box-check\"><i class=\"icon-material-outline-check\"></i></div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t\t<h3>Create an Account</h3>\n\t\t\t\t\t<p>The Online Services Gateway dashboard is super simple to use. Whether a sole trader or a CMO, you will have\n\t\t\t\t\t\tcampaigns launched in minutes.</p>\n\t\t\t\t</div>\n\t\t\t</div>\n\n\t\t\t<div class=\"col-xl-4 col-md-4\">\n\t\t\t\t<!-- Icon Box -->\n\t\t\t\t<div class=\"icon-box with-line\">\n\t\t\t\t\t<!-- Icon -->\n\t\t\t\t\t<div class=\"icon-box-circle\">\n\t\t\t\t\t\t<div class=\"icon-box-circle-inner\">\n\t\t\t\t\t\t\t<i class=\"icon-feather-mail\"></i>\n\t\t\t\t\t\t\t<div class=\"icon-box-check\"><i class=\"icon-material-outline-check\"></i></div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t\t<h3>Send a message</h3>\n\t\t\t\t\t<p>Whether it’s a bulk SMS marketing campaign or transactional SMS at scale via our SMS Gateway API you need\n\t\t\t\t\t\tto be confident your messages are being delivered. Online Serives provides that confidence by the use of\n\t\t\t\t\t\tdirect\n\t\t\t\t\t\troutes and 100% Uptime SLA Guarantee.</p>\n\t\t\t\t</div>\n\t\t\t</div>\n\n\t\t\t<div class=\"col-xl-4 col-md-4\">\n\t\t\t\t<!-- Icon Box -->\n\t\t\t\t<div class=\"icon-box\">\n\t\t\t\t\t<!-- Icon -->\n\t\t\t\t\t<div class=\"icon-box-circle\">\n\t\t\t\t\t\t<div class=\"icon-box-circle-inner\">\n\t\t\t\t\t\t\t<i class=\"icon-feather-rss\"></i>\n\t\t\t\t\t\t\t<div class=\"icon-box-check\"><i class=\"icon-material-outline-check\"></i></div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t\t<h3>Choose a service</h3>\n\t\t\t\t\t<p>Automate your SMS communications without losing personalisation. Use our autoresponder service to build an\n\t\t\t\t\t\tinteractive experience, picking up on SMS keywords and responding automatically.</p>\n\t\t\t\t</div>\n\t\t\t</div>\n\n\t\t</div>\n\t</div>\n</div>\n<!-- Membership Plans -->\n<div class=\"section padding-top-60 padding-bottom-75\">\n\t<div class=\"container\">\n\t\t<div class=\"row\">\n\n\t\t\t<div class=\"col-xl-12\">\n\t\t\t\t<!-- Section Headline -->\n\t\t\t\t<div class=\"section-headline centered margin-top-0 margin-bottom-70\">\n\t\t\t\t\t<h3>SMS Services Plans</h3>\n\t\t\t\t</div>\n\t\t\t</div>\n\n\n\t\t\t<div class=\"col-xl-12\">\n\n\t\t\t\t<!-- Pricing Plans Container -->\n\t\t\t\t<div class=\"pricing-plans-container\">\n\n\t\t\t\t\t<!-- Plan -->\n\t\t\t\t\t<div class=\"pricing-plan\">\n\t\t\t\t\t\t<h3>Basic Plan</h3>\n\t\t\t\t\t\t<p class=\"margin-top-10\">We'll beat any cheaper comparable quotes.</p>\n\t\t\t\t\t\t<div class=\"pricing-plan-label billed-monthly-label\"><strong>$6,99</strong></div>\n\t\t\t\t\t\t<div class=\"pricing-plan-features\">\n\t\t\t\t\t\t\t<strong>Features of Basic Plan</strong>\n\t\t\t\t\t\t\t<ul>\n\t\t\t\t\t\t\t\t<li>50 messages</li>\n\t\t\t\t\t\t\t\t<li>Free 24/7 support</li>\n\t\t\t\t\t\t\t\t<li>Global coverage</li>\n\t\t\t\t\t\t\t</ul>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\n\t\t\t\t\t<!-- Plan -->\n\t\t\t\t\t<div class=\"pricing-plan recommended\">\n\t\t\t\t\t\t<div class=\"recommended-badge\">Recommended</div>\n\t\t\t\t\t\t<h3>Standard Plan</h3>\n\t\t\t\t\t\t<p class=\"margin-top-10\">We'll beat any cheaper comparable quotes.</p>\n\t\t\t\t\t\t<div class=\"pricing-plan-label billed-monthly-label\"><strong>$13,99</strong></div>\n\t\t\t\t\t\t<div class=\"pricing-plan-features\">\n\t\t\t\t\t\t\t<strong>Features of Standard Plan</strong>\n\t\t\t\t\t\t\t<ul>\n\t\t\t\t\t\t\t\t<li>100 messages</li>\n\t\t\t\t\t\t\t\t<li>Free 24/7 support</li>\n\t\t\t\t\t\t\t\t<li>Global coverage</li>\n\t\t\t\t\t\t\t</ul>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\n\t\t\t\t\t<!-- Plan -->\n\t\t\t\t\t<div class=\"pricing-plan\">\n\t\t\t\t\t\t<h3>Extended Plan</h3>\n\t\t\t\t\t\t<p class=\"margin-top-10\">We'll beat any cheaper comparable quotes.</p>\n\t\t\t\t\t\t<div class=\"pricing-plan-label billed-monthly-label\"><strong>$64,99</strong></div>\n\t\t\t\t\t\t<div class=\"pricing-plan-features\">\n\t\t\t\t\t\t\t<strong>Features of Extended Plan</strong>\n\t\t\t\t\t\t\t<ul>\n\t\t\t\t\t\t\t\t<li>500  messages</li>\n\t\t\t\t\t\t\t\t<li>Free 24/7 support</li>\n\t\t\t\t\t\t\t\t<li>Global coverage</li>\n\t\t\t\t\t\t\t</ul>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\n\t\t\t</div>\n\n\t\t</div>\n\t</div>\n</div>\n<!-- Features Jobs -->\n<div class=\"section gray margin-top-45 padding-top-65 padding-bottom-75\">\n\t<div class=\"container\">\n\t\t<div class=\"row\">\n\t\t\t<div class=\"col-xl-12\">\n\n\t\t\t\t<!-- Section Headline -->\n\t\t\t\t<div class=\"section-headline margin-top-0 margin-bottom-35\">\n\t\t\t\t\t<h3>Some of our hottest Friends</h3>\n\t\t\t\t</div>\n\n\t\t\t\t<!-- Jobs Container -->\n\t\t\t\t<div class=\"listings-container compact-list-layout margin-top-35\">\n\n\t\t\t\t\t<!-- Job Listing -->\n\t\t\t\t\t<a href=\"javascript:void(0)\" class=\"job-listing with-apply-button\" *ngFor=\"let item of friend\">\n\n\t\t\t\t\t\t<!-- Job Listing Details -->\n\t\t\t\t\t\t<div class=\"job-listing-details\">\n\n\t\t\t\t\t\t\t<!-- Logo -->\n\t\t\t\t\t\t\t<div class=\"job-listing-company-logo\">\n\t\t\t\t\t\t\t\t<img src=\"{{item.Avatar}}\" alt=\"\">\n\t\t\t\t\t\t\t</div>\n\n\t\t\t\t\t\t\t<!-- Details -->\n\t\t\t\t\t\t\t<div class=\"job-listing-description\">\n\t\t\t\t\t\t\t\t<h3 class=\"job-listing-title\">{{item.Name}}</h3>\n\n\t\t\t\t\t\t\t\t<!-- Job Listing Footer -->\n\t\t\t\t\t\t\t\t<div class=\"job-listing-footer\">\n\t\t\t\t\t\t\t\t\t<ul>\n\t\t\t\t\t\t\t\t\t\t<li><i class=\"icon-material-outline-business\"></i> Available <div class=\"verified-badge\"\n\t\t\t\t\t\t\t\t\t\t\t\ttitle=\"Verified Employer\" data-tippy-placement=\"top\"></div>\n\t\t\t\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t\t\t\t\t<!-- <li><i class=\"icon-material-outline-location-on\"></i> San Francissco</li> -->\n\t\t\t\t\t\t\t\t\t\t<!-- <li><i class=\"icon-material-outline-business-center\"></i> Full Time</li> -->\n\t\t\t\t\t\t\t\t\t\t<!-- <li><i class=\"icon-material-outline-access-time\"></i>{{item.Email}}</li> -->\n\t\t\t\t\t\t\t\t\t</ul>\n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</a>\n\n\t\t\t\t</div>\n\t\t\t\t<!-- Jobs Container / End -->\n\n\t\t\t</div>\n\t\t</div>\n\t</div>\n</div>\n<!-- Featured Jobs / End -->\n<!-- Membership Plans / End-->";
    /***/
  },
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppLayoutFooterFooterComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<div id=\"footer\">\n\n\t<!-- Footer Middle Section -->\n\t<div class=\"footer-middle-section\">\n\t\t<div class=\"container\">\n\t\t\t<div class=\"row\">\n\n\t\t\t\t<!-- Links -->\n\t\t\t\t<div class=\"col-xl-2 col-lg-2 col-md-3\">\n\t\t\t\t\t<div class=\"footer-links\">\n\t\t\t\t\t\t<h3>Helpful Links</h3>\n\t\t\t\t\t\t<ul>\n\t\t\t\t\t\t\t<li><a href=\"#\"><span>Contact</span></a></li>\n\t\t\t\t\t\t\t<li><a href=\"#\"><span>Privacy Policy</span></a></li>\n\t\t\t\t\t\t\t<li><a href=\"#\"><span>Terms of Use</span></a></li>\n\t\t\t\t\t\t</ul>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\n\t\t\t\t<!-- Links -->\n\t\t\t\t<div class=\"col-xl-2 col-lg-2 col-md-3\">\n\t\t\t\t\t<div class=\"footer-links\">\n\t\t\t\t\t\t<h3>Account</h3>\n\t\t\t\t\t\t<ul>\n\t\t\t\t\t\t\t<li><a href=\"#\"><span>Log In</span></a></li>\n\t\t\t\t\t\t\t<li><a href=\"#\"><span>My Account</span></a></li>\n\t\t\t\t\t\t</ul>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\n\t\t\t\t<!-- Newsletter -->\n\t\t\t\t<div class=\"col-xl-4 col-lg-4 col-md-12\">\n\t\t\t\t\t<h3><i class=\"icon-feather-mail\"></i> Sign Up For a Newsletter</h3>\n\t\t\t\t\t<p>Weekly breaking news, analysis and cutting edge advices on job searching.</p>\n\t\t\t\t\t<form action=\"#\" method=\"get\" class=\"newsletter\">\n\t\t\t\t\t\t<input type=\"text\" name=\"fname\" placeholder=\"Enter your email address\">\n\t\t\t\t\t\t<button type=\"submit\"><i class=\"icon-feather-arrow-right\"></i></button>\n\t\t\t\t\t</form>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n\t<!-- Footer Middle Section / End -->\n\t\n\t<!-- Footer Copyrights -->\n\t<div class=\"footer-bottom-section\">\n\t\t<div class=\"container\">\n\t\t\t<div class=\"row\">\n\t\t\t\t<div class=\"col-xl-12\">\n\t\t\t\t\t© 2018 <strong>Online Services</strong>. All Rights Reserved.\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n\t<!-- Footer Copyrights / End -->\n\n</div>";
    /***/
  },
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppLayoutHeaderHeaderComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<!-- Header Container\n================================================== -->\n<header id=\"header-container\" class=\"fullwidth transparent\">\n\n\t<!-- Header -->\n\t<div id=\"header\">\n\t\t<div class=\"container\">\n\n\t\t\t<!-- Left Side Content -->\n\t\t\t<div class=\"left-side\">\n\n\t\t\t\t<!-- Logo -->\n\t\t\t\t<div id=\"logo\">\n\t\t\t\t\t<a href=\"javascript:void(0)\"><img src=\"../../../assets/admin/images/logo.png\" alt=\"\"></a>\n\t\t\t\t</div>\n\n\t\t\t\t<!-- Main Navigation -->\n\t\t\t\t<nav id=\"navigation\">\n\t\t\t\t\t<ul id=\"responsive\">\n\n\t\t\t\t\t\t<li><a [routerLink]=\"['/client/home']\" class=\"current\">Home</a>\n\t\t\t\t\t\t</li>\n\t\t\t\t\t\t<li *ngIf=\"isUserInfo\"><a [routerLink]=\"['/profile/setting']\" class=\"current\">My Profile</a>\n\t\t\t\t\t\t</li>\n\n\t\t\t\t\t</ul>\n\t\t\t\t</nav>\n\t\t\t\t<div class=\"clearfix\"></div>\n\t\t\t\t<!-- Main Navigation / End -->\n\n\t\t\t</div>\n\t\t\t<!-- Left Side Content / End -->\n\n\n\t\t\t<!-- Right Side Content / End -->\n\t\t\t<div class=\"right-side\">\n\n\t\t\t\t<div class=\"header-widget\">\n\t\t\t\t\t<a class=\"popup-with-zoom-anim log-in-button\" (click)=\"openDialog()\" *ngIf=\"!isUserInfo\"><i class=\"icon-feather-log-in\"></i>\n\t\t\t\t\t\t<span>Log In / Register</span>\n\t\t\t\t\t</a>\n\t\t\t\t\t<a class=\"popup-with-zoom-anim log-in-button\" (click)=\"logout()\"  *ngIf=\"isUserInfo\"><i class=\"icon-feather-log-in\"></i>\n\t\t\t\t\t\t<span>Log out</span>\n\t\t\t\t\t</a>\n\t\t\t\t</div>\n\n\t\t\t\t<!-- Mobile Navigation Button -->\n\t\t\t\t<span class=\"mmenu-trigger\">\n\t\t\t\t\t<button class=\"hamburger hamburger--collapse\" type=\"button\">\n\t\t\t\t\t\t<span class=\"hamburger-box\">\n\t\t\t\t\t\t\t<span class=\"hamburger-inner\"></span>\n\t\t\t\t\t\t</span>\n\t\t\t\t\t</button>\n\t\t\t\t</span>\n\n\t\t\t</div>\n\t\t\t<!-- Right Side Content / End -->\n\n\t\t</div>\n\t</div>\n\t<!-- Header / End -->\n\n</header>\n<div class=\"clearfix\"></div>\n<!-- Header Container / End -->";
    /***/
  },
  ...
  /***/
  "./node_modules/raw-loader/dist/cjs.js!./src/app/profile/invoice/invoice.component.html":
  /*!**********************************************************************************************!*\
    !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/profile/invoice/invoice.component.html ***!
    \**********************************************************************************************/
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppProfileInvoiceInvoiceComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "<!-- Print Button -->\n<div class=\"print-button-container\">\n  <a href=\"javascript:void(0)\" (click) = \"goBack()\" class=\"print-button\" style=\"margin-right: 20px;\">Go to Home</a>\n  <a href=\"javascript:window.print()\"  class=\"print-button\">Print this invoice</a>\n</div>\n\n<!-- Invoice -->\n<div id=\"invoice\">\n\n  <!-- Header -->\n  <div class=\"row\">\n    <div class=\"col-xl-6\">\n      <div id=\"logo\"><img src=\"../../../assets/admin/images/logo.png\" alt=\"\"></div>\n    </div>\n\n    <div class=\"col-xl-6\">\n\n      <p id=\"details\">\n        <strong>Order:</strong> #00124 <br>\n        <strong>Issued:</strong> {{this.currentDate}}<br>\n        Due 7 days from date of issue\n      </p>\n    </div>\n  </div>\n\n\n  <!-- Client & Supplier -->\n  <div class=\"row\">\n    <div class=\"col-xl-12\">\n      <h2>Invoice</h2>\n    </div>\n\n    <div class=\"col-xl-6\">\n      <strong class=\"margin-bottom-5\">Supplier</strong>\n      <p>\n        Online Services <br>\n        8A Ton That Thuyet Street, Detech Tower <br>\n        Hanoi, CF44 6ZL, VietNam <br>\n      </p>\n    </div>\n\n    <div class=\"col-xl-6\">\n      <strong class=\"margin-bottom-5\">Customer</strong>\n      <p>\n        {{userName}} <br>\n        36 Edgewater Street <br>\n        Melbourne, 2540, Australia <br>\n      </p>\n    </div>\n  </div>\n\n\n  <!-- Invoice -->\n  <div class=\"row\">\n    <div class=\"col-xl-12\">\n      <table class=\"margin-top-20\">\n        <tr>\n          <th>Description</th>\n          <th>Price</th>\n          <th>VAT (20%)</th>\n          <th>Total</th>\n        </tr>\n\n        <tr>\n          <td>{{this.subscriptionType}} Plan</td>\n          <td>${{this.fee}}</td>\n          <td>${{this.vat}}</td>\n          <td>${{this.total}}</td>\n        </tr>\n      </table>\n    </div>\n\n    <div class=\"col-xl-4 col-xl-offset-8\">\n      <table id=\"totals\">\n        <tr>\n          <th>Total Due</th>\n          <th><span>${{this.total}}</span></th>\n        </tr>\n      </table>\n    </div>\n  </div>\n\n\n  <!-- Footer -->\n  <div class=\"row\">\n    <div class=\"col-xl-12\">\n      <ul id=\"footer\">\n        <li><span>https://sms-service-t1809e.herokuapp.com/</span></li>\n        <li>fpt@example.com</li>\n        <li>(+84) 38 386 0666</li>\n      </ul>\n    </div>\n  </div>\n\n</div>";
    /***/
  },

  /***/
  "./node_modules/raw-loader/dist/cjs.js!./src/app/profile/sms-extension-popup/sms-extension-popup.component.html":
  /*!**********************************************************************************************************************!*\
    !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/profile/sms-extension-popup/sms-extension-popup.component.html ***!
    \**********************************************************************************************************************/
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppProfileSmsExtensionPopupSmsExtensionPopupComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "<div class=\"section\">\n  <div class=\"container\">\n    <div class=\"row\">\n\n      <div class=\"col-xl-12\">\n        <!-- Section Headline -->\n        <div class=\"section-headline centered margin-top-0 margin-bottom-70\">\n          <h3>SMS Services Plans</h3>\n        </div>\n      </div>\n\n\n      <div class=\"col-xl-12\">\n\n        <!-- Pricing Plans Container -->\n        <div class=\"pricing-plans-container\">\n\n          <!-- Plan -->\n          <div class=\"pricing-plan\">\n            <h3>Basic Plan</h3>\n            <p class=\"margin-top-10\">We'll beat any cheaper comparable quotes.</p>\n            <div class=\"pricing-plan-label billed-monthly-label\"><strong>$6,99</strong></div>\n            <div class=\"pricing-plan-features\">\n              <strong>Features of Basic Plan</strong>\n              <ul>\n                <li>50 messages</li>\n                <li>Free 24/7 support</li>\n                <li>Global coverage</li>\n              </ul>\n            </div>\n            <a href=\"javascript:void(0)\"  class=\"button full-width margin-top-20\" (click)=\"goToCheckout(6,99, 'Basic')\">Buy Now</a>\n          </div>\n\n          <!-- Plan -->\n          <div class=\"pricing-plan recommended\">\n            <div class=\"recommended-badge\">Recommended</div>\n            <h3>Standard Plan</h3>\n            <p class=\"margin-top-10\">We'll beat any cheaper comparable quotes.</p>\n            <div class=\"pricing-plan-label billed-monthly-label\"><strong>$13,99</strong></div>\n            <div class=\"pricing-plan-features\">\n              <strong>Features of Standard Plan</strong>\n              <ul>\n                <li>100 messages</li>\n                <li>Free 24/7 support</li>\n                <li>Global coverage</li>\n              </ul>\n            </div>\n            <a href=\"javascript:void(0)\"  class=\"button full-width margin-top-20\" (click)=\"goToCheckout(13,99, 'Standard')\">Buy Now</a>\n          </div>\n\n          <!-- Plan -->\n          <div class=\"pricing-plan\">\n            <h3>Extended Plan</h3>\n            <p class=\"margin-top-10\">We'll beat any cheaper comparable quotes.</p>\n            <div class=\"pricing-plan-label billed-monthly-label\"><strong>$64,99</strong></div>\n            <div class=\"pricing-plan-features\">\n              <strong>Features of Extended Plan</strong>\n              <ul>\n                <li>500 messages</li>\n                <li>Free 24/7 support</li>\n                <li>Global coverage</li>\n              </ul>\n            </div>\n            <a href=\"javascript:void(0)\"  class=\"button full-width margin-top-20\" (click)=\"goToCheckout(64,99, 'Extended')\">Buy Now</a>\n          </div>\n        </div>\n\n      </div>\n\n    </div>\n  </div>\n</div>";
    /***/
  },
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppProfileSubscriptionPopupSubscriptionPopupComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<!-- Membership Plans -->\n<div class=\"section\">\n\t<div class=\"container\">\n\t\t<div class=\"row\">\n\n\t\t\t<div class=\"col-xl-12\">\n\t\t\t\t<!-- Section Headline -->\n\t\t\t\t<div class=\"section-headline centered margin-top-0 margin-bottom-35\">\n          <h3>Subscription Plans</h3>\n\t\t\t\t</div>\n\t\t\t</div>\n\n\n\t\t\t<div class=\"col-xl-12\">\n\n\t\t\t\t<!-- Billing Cycle  -->\n\n\t\t\t\t<!-- Pricing Plans Container -->\n\t\t\t\t<div class=\"pricing-plans-container\">\n\n\t\t\t\t\t<!-- Plan -->\n\t\t\t\t\t<div class=\"pricing-plan\">\n\t\t\t\t\t\t<h3>Basic Plan</h3>\n\t\t\t\t\t\t<div class=\"pricing-plan-label billed-monthly-label\"><strong>{{price}} $</strong>/ monthly</div>\n\t\t\t\t\t\t<div class=\"pricing-plan-features\">\n\t\t\t\t\t\t\t<strong>Features of Basic Plan</strong>\n\t\t\t\t\t\t\t<ul>\n\t\t\t\t\t\t\t\t<li>1 Listing</li>\n\t\t\t\t\t\t\t\t<li>30 Days Visibility</li>\n\t\t\t\t\t\t\t\t<li>Highlighted in Search Results</li>\n\t\t\t\t\t\t\t</ul>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<a href=\"javascript:void(0)\"  class=\"button full-width margin-top-20\" (click)=\"goToCheckout(price, 'Basic')\">Buy Now</a>\n\t\t\t\t\t</div>\n\n\t\t\t\t\t<!-- Plan -->\n\t\t\t\t\t<div class=\"pricing-plan recommended\">\n\t\t\t\t\t\t<div class=\"recommended-badge\">Recommended</div>\n\t\t\t\t\t\t<h3>Standard Plan</h3>\n\t\t\t\t\t\t<div class=\"pricing-plan-label billed-monthly-label\"><strong>{{price * 6}} $</strong>/ 6 months</div>\n\t\t\t\t\t\t<div class=\"pricing-plan-features\">\n\t\t\t\t\t\t\t<strong>Features of Standard Plan</strong>\n\t\t\t\t\t\t\t<ul>\n\t\t\t\t\t\t\t\t<li>5 Listings</li>\n\t\t\t\t\t\t\t\t<li>60 Days Visibility</li>\n\t\t\t\t\t\t\t\t<li>Highlighted in Search Results</li>\n\t\t\t\t\t\t\t</ul>\n\t\t\t\t\t\t</div>\n            <a href=\"javascript:void(0)\"  class=\"button full-width margin-top-20\" (click)=\"goToCheckout(price * 6, 'Standard')\">Buy Now</a>\n\t\t\t\t\t</div>\n\n\t\t\t\t\t<!-- Plan -->\n\t\t\t\t\t<div class=\"pricing-plan\">\n\t\t\t\t\t\t<h3>Extended Plan</h3>\n\t\t\t\t\t\t<div class=\"pricing-plan-label billed-monthly-label\"><strong>{{price * 12}} $</strong>/ year</div>\n\t\t\t\t\t\t<div class=\"pricing-plan-features\">\n\t\t\t\t\t\t\t<strong>Features of Extended Plan</strong>\n\t\t\t\t\t\t\t<ul>\n\t\t\t\t\t\t\t\t<li>Unlimited Listings Listing</li>\n\t\t\t\t\t\t\t\t<li>90 Days Visibility</li>\n\t\t\t\t\t\t\t\t<li>Highlighted in Search Results</li>\n\t\t\t\t\t\t\t</ul>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<a href=\"javascript:void(0)\"  class=\"button full-width margin-top-20\" (click)=\"goToCheckout(price * 12, 'Extended')\">Buy Now</a>\n          </div>\n          \n\n\t\t\t\t</div>\n\n      </div>\n      \n      <!-- <div class=\"paypal_section col-xl-12\" #paypal></div> -->\n\n\n\t\t</div>\n\t</div>\n</div>\n\n<script src=\"https://www.paypal.com/sdk/js?client-id=AS3JLKKieETS2ocsg4X-PKPE5_q9zp1WEINeCHLTwniEjCnYPOQ1U3uuNBofUCBZo_qq_OTymJXj25S_\"></script>\n\n<!-- Membership Plans / End-->";
    /***/
  },
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _layout_page_not_found_page_not_found_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    var _admin_admin_login_admin_login_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./admin/admin-login/admin-login.component */
    "./src/app/admin/admin-login/admin-login.component.ts");
    /* harmony import */


    var _profile_invoice_invoice_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./profile/invoice/invoice.component */
    "./src/app/profile/invoice/invoice.component.ts");
    ...
    var routes = [{
      ...
      children: [{
        ...
        path: 'pages-404',
        component: _layout_page_not_found_page_not_found_component__WEBPACK_IMPORTED_MODULE_5__["PageNotFoundComponent"]
      }]
    }, {
      path: 'profile',
      ...
      path: 'admin/login',
      component: _admin_admin_login_admin_login_component__WEBPACK_IMPORTED_MODULE_8__["AdminLoginComponent"]
    }, {
      path: 'admin',
      ...
      path: 'invoice',
      component: _profile_invoice_invoice_component__WEBPACK_IMPORTED_MODULE_9__["InvoiceComponent"]
    }, {
      path: '',
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var simplebar_angular__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! simplebar-angular */
    "./node_modules/simplebar-angular/fesm2015/simplebar-angular.js");
    /* harmony import */


    var _layout_page_not_found_page_not_found_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
    /*! ./layout/page-not-found/page-not-found.component */
    "./src/app/layout/page-not-found/page-not-found.component.ts");
    /* harmony import */
    ...
    var _state_app_reducer__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
    /*! ./state/app.reducer */
    "./src/app/state/app.reducer.ts");
    /* harmony import */


    var _ngrx_effects__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(
    /*! @ngrx/effects */
    ...
    var _profile_subscription_popup_subscription_popup_component__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(
    ...
    var _admin_admin_login_admin_login_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(
    /*! ./admin/admin-login/admin-login.component */
    "./src/app/admin/admin-login/admin-login.component.ts");
    /* harmony import */
    ...
    var _profile_invoice_invoice_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(
    /*! ./profile/invoice/invoice.component */
    "./src/app/profile/invoice/invoice.component.ts");
    /* harmony import */


    var _profile_sms_extension_popup_sms_extension_popup_component__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(
    /*! ./profile/sms-extension-popup/sms-extension-popup.component */
    "./src/app/profile/sms-extension-popup/sms-extension-popup.component.ts"); // NgrX
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _auth_login_login_component__WEBPACK_IMPORTED_MODULE_5__["LoginComponent"], _layout_header_header_component__WEBPACK_IMPORTED_MODULE_8__["HeaderComponent"], _layout_footer_footer_component__WEBPACK_IMPORTED_MODULE_9__["FooterComponent"], _layout_normal_layout_normal_layout_component__WEBPACK_IMPORTED_MODULE_16__["NormalLayoutComponent"], // ProfileLayoutComponent, 
      _layout_page_not_found_page_not_found_component__WEBPACK_IMPORTED_MODULE_18__["PageNotFoundComponent"], _profile_subscription_popup_subscription_popup_component__WEBPACK_IMPORTED_MODULE_28__["SubscriptionPopupComponent"], _admin_admin_login_admin_login_component__WEBPACK_IMPORTED_MODULE_30__["AdminLoginComponent"], _admin_admin_component__WEBPACK_IMPORTED_MODULE_29__["AdminComponent"], _profile_sms_extension_popup_sms_extension_popup_component__WEBPACK_IMPORTED_MODULE_35__["SmsExtensionPopupComponent"], _profile_invoice_invoice_component__WEBPACK_IMPORTED_MODULE_34__["InvoiceComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_6__["BrowserAnimationsModule"], _material_module__WEBPACK_IMPORTED_MODULE_7__["MaterialModule"], _feature_feature_module__WEBPACK_IMPORTED_MODULE_10__["FeatureModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_11__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_14__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_14__["ReactiveFormsModule"], _sweetalert2_ngx_sweetalert2__WEBPACK_IMPORTED_MODULE_15__["SweetAlert2Module"].forRoot(), _ngrx_store__WEBPACK_IMPORTED_MODULE_21__["StoreModule"].forRoot({
        count: _state_app_reducer__WEBPACK_IMPORTED_MODULE_22__["counterReducer"]
      }), _ngrx_effects__WEBPACK_IMPORTED_MODULE_23__["EffectsModule"].forRoot([]), _ngrx_store_devtools__WEBPACK_IMPORTED_MODULE_20__["StoreDevtoolsModule"].instrument({
        maxAge: 25,
        logOnly: src_environments_environment__WEBPACK_IMPORTED_MODULE_19__["environment"].production
      }), simplebar_angular__WEBPACK_IMPORTED_MODULE_17__["SimplebarAngularModule"], _angular_fire__WEBPACK_IMPORTED_MODULE_24__["AngularFireModule"].initializeApp(firebaseConfig), _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_25__["AngularFirestoreModule"], _angular_fire_auth__WEBPACK_IMPORTED_MODULE_27__["AngularFireAuthModule"], _angular_fire_storage__WEBPACK_IMPORTED_MODULE_26__["AngularFireStorageModule"], ng2_charts__WEBPACK_IMPORTED_MODULE_31__["ChartsModule"], ngx_intl_tel_input__WEBPACK_IMPORTED_MODULE_32__["NgxIntlTelInputModule"], ngx_spinner__WEBPACK_IMPORTED_MODULE_33__["NgxSpinnerModule"]],
      providers: [{
      ...
      entryComponents: [_auth_login_login_component__WEBPACK_IMPORTED_MODULE_5__["LoginComponent"], _profile_subscription_popup_subscription_popup_component__WEBPACK_IMPORTED_MODULE_28__["SubscriptionPopupComponent"], _profile_sms_extension_popup_sms_extension_popup_component__WEBPACK_IMPORTED_MODULE_35__["SmsExtensionPopupComponent"]]
    })], AppModule);
    /***/
  },
  ...
  function srcAppAuthLoginLoginComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".mat-dialog-container {\n  padding: 0;\n  overflow: hidden;\n}\n\n.mat-dialog-content {\n  margin: 0;\n  padding: 0;\n}\n\n.mat-tab-labels {\n  background: #f8f8f8;\n}\n\n.mat-tab-label {\n  border-right: 1px solid #e0e0e0;\n}\n\n.mat-tab-label-active {\n  color: #2a41e8;\n  font-weight: 600;\n}\n\n.mat-radio-checked .mat-radio-outer-circle {\n  border-color: #2a41e8 !important;\n}\n\n.mat-radio-inner-circle {\n  background-color: #2a41e8 !important;\n}\n\n.mat-radio-group {\n  display: flex;\n  justify-content: space-around;\n}\n\n.phone-verification-header {\n  font-weight: 700;\n  color: #333;\n  font-size: 24px;\n  font-family: \"Nunito\", \"HelveticaNeue\", \"Helvetica Neue\", Helvetica, Arial, sans-serif;\n}\n\n.swal2-actions {\n  justify-content: space-between;\n}\n\n.intl-tel-input {\n  width: 100%;\n  border: 1px solid #e0e0e0;\n  box-shadow: 0 1px 4px 0px rgba(0, 0, 0, 0.05);\n}\n\n.intl-tel-input input {\n  padding-left: 110px !important;\n}\n\n.intl-tel-input .flag-container {\n  padding: 0px;\n}\n\n.uploadAvatarBtn {\n  margin-top: 20px;\n  margin-bottom: 20px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppAuthLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var LoginComponent = /*#__PURE__*/function () {
      ...
      storage) {
        ...
        this.TooltipLabel = ngx_intl_tel_input__WEBPACK_IMPORTED_MODULE_10__["TooltipLabel"];
      ...
      _createClass(LoginComponent, [{
            ...
            task.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["finalize"])(function () {
              ...
              _this3.downloadURL.subscribe(function (url) {
                if (url) {
                  ...
                  _this3.authenticationService.register(_this3.f.email.value, _this3.f.password.value, _this3.f.password.value, _this3.f.phoneNumber.value.e164Number, _this3.fb, _this3.f.name.value, parseInt(_this3.f.gender.value)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["first"])()).subscribe(function (data) {
                    if (data) {
                      console.log(data);
        ...
        value: function changePreferredCountries() {
          this.preferredCountries = [ngx_intl_tel_input__WEBPACK_IMPORTED_MODULE_10__["CountryISO"].India, ngx_intl_tel_input__WEBPACK_IMPORTED_MODULE_10__["CountryISO"].Canada];
        }
      }, {
        key: "uploadAvatar",
          ...
          sweetalert2__WEBPACK_IMPORTED_MODULE_6___default.a.fire({
            ...
            if (result.value) {
              _this5.authenticationService.phoneVerification(_this5.userId, result.value).subscribe(function (data) {
                if (data) {
                  _this5.alertService.successCounterup('Register', 'Register Success, please Sign in again .');
  ...
  function srcAppFeatureHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var HomeComponent = /*#__PURE__*/function () {
      function HomeComponent(dashBoardService, adminService, store, alertService, router) {
      ...
      _createClass(HomeComponent, [{
        ...
        value: function getSuggestionFriend() {
          ...
          this.adminService.getRecommendFriendPublic().subscribe(function (friends) {
            console.log(friends);
  ...
  function srcAppLayoutHeaderHeaderComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var HeaderComponent = /*#__PURE__*/function () {
      function HeaderComponent(dialog, authenticationService) {
  ...
  /***/
  "./src/app/profile/invoice/invoice.component.scss":
  /*!********************************************************!*\
    !*** ./src/app/profile/invoice/invoice.component.scss ***!
    \********************************************************/
  ...
  /***/
  function srcAppProfileInvoiceInvoiceComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "html {\n  font-family: \"Nunito\", \"HelveticaNeue\", \"Helvetica Neue\", Helvetica, Arial, sans-serif;\n  text-transform: none;\n  font-size: 100%;\n}\n\nstrong {\n  font-weight: 600;\n  color: #333;\n  display: inline-block;\n}\n\nbody {\n  background: #f4f4f4;\n  color: #666;\n  font-weight: 300;\n  line-height: 28px;\n}\n\n#invoice {\n  background: white;\n  width: auto;\n  max-width: 900px;\n  padding: 60px;\n  margin: 0px auto 60px auto;\n  border-radius: 4px;\n}\n\nh1,\nh2,\nh3 {\n  font-weight: 300;\n  color: #333;\n  clear: both;\n  margin: 0;\n}\n\nh2 {\n  font-size: 36px;\n  line-height: 1;\n  margin: 15px 0 45px 0;\n}\n\np {\n  margin: 0;\n  padding-bottom: 40px;\n  clear: both;\n}\n\n#logo img {\n  max-height: 44px;\n  transform: translate3d(0, 0, 0);\n}\n\n#details {\n  text-align: right;\n}\n\ntable {\n  width: 100%;\n  margin: 0 0 30px;\n  padding: 1px 0;\n  border-spacing: 0;\n  border-bottom: 1px solid #ddd;\n}\n\nth,\ntd {\n  padding: 15px 0;\n  text-align: left;\n}\n\nth {\n  font-weight: 700;\n  border-bottom: 1px solid #ddd;\n  font-size: 16px;\n  color: #333;\n}\n\nth:last-child,\ntd:last-child {\n  text-align: right;\n}\n\nth span {\n  position: relative;\n  display: inline-block;\n  height: 100%;\n}\n\nth span::after {\n  content: \"\";\n  width: 100%;\n  bottom: -16px;\n  position: absolute;\n  right: 0;\n  border-bottom: 1px solid #2a41e8;\n}\n\n#footer {\n  width: 100%;\n  border-top: 1px solid #ddd;\n  margin: 60px 0 0 0;\n  padding: 20px 0 0 0;\n  list-style: none;\n  font-size: 15px;\n}\n\n#footer li {\n  display: inline-block;\n  padding: 0 20px;\n  border-right: 1px solid #ddd;\n  line-height: 11px;\n}\n\n#footer li:first-child {\n  padding-left: 0;\n}\n\n#footer li:last-child {\n  border: none;\n}\n\n#footer li span {\n  color: #2a41e8;\n}\n\n.margin-top-20 {\n  margin-top: 20px;\n}\n\n.margin-bottom-5 {\n  margin-bottom: 5px;\n}\n\n.print-button-container {\n  width: 100%;\n  text-align: center;\n}\n\n.print-button,\n.print-button:hover {\n  line-height: 24px;\n  font-size: 15px;\n  font-weight: 600;\n  color: #fff;\n  background-color: #333;\n  box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);\n  border-radius: 4px;\n  padding: 10px 20px;\n  display: inline-block;\n  text-align: center;\n  margin: 40px auto 40px auto;\n  transition: 0.3s;\n  text-decoration: none !important;\n  outline: none !important;\n  width: auto;\n}\n\n.print-button:hover {\n  background-color: #444;\n}\n\n/* Print Styles*/\n\n@media print {\n  .print-button-container,\n.print-button {\n    display: none;\n    opacity: 0;\n    visibility: hidden;\n    height: 0;\n  }\n\n  body {\n    background: #fff;\n    height: 100%;\n    color: #666;\n  }\n\n  strong,\nth,\nh1,\nh2,\nh3 {\n    color: #111;\n  }\n\n  table,\nth,\n#footer,\n#footer li {\n    border-color: #bbb;\n  }\n\n  @page {\n    size: A4;\n    margin: 0 17mm;\n  }\n  #invoice {\n    max-width: 100%;\n    padding: 17mm 0;\n    margin: 0;\n    position: relative;\n  }\n\n  #details {\n    position: relative;\n    top: -30px;\n  }\n\n  #footer {\n    position: fixed;\n    bottom: 17mm;\n  }\n\n  .content-block, p {\n    page-break-inside: avoid;\n  }\n\n  html, body {\n    width: 210mm;\n    height: 297mm;\n  }\n\n  .col-md-1,\n.col-md-2,\n.col-md-3,\n.col-md-4,\n.col-md-5,\n.col-md-6,\n.col-md-7,\n.col-md-8,\n.col-md-9,\n.col-md-10,\n.col-md-11,\n.col-md-12 {\n    float: left;\n  }\n\n  .col-md-12 {\n    width: 100%;\n  }\n\n  .col-md-11 {\n    width: 91.66666667%;\n  }\n\n  .col-md-10 {\n    width: 83.33333333%;\n  }\n\n  .col-md-9 {\n    width: 75%;\n  }\n\n  .col-md-8 {\n    width: 66.66666667%;\n  }\n\n  .col-md-7 {\n    width: 58.33333333%;\n  }\n\n  .col-md-6 {\n    width: 50%;\n  }\n\n  .col-md-5 {\n    width: 41.66666667%;\n  }\n\n  .col-md-4 {\n    width: 33.33333333%;\n  }\n\n  .col-md-3 {\n    width: 25%;\n  }\n\n  .col-md-2 {\n    width: 16.66666667%;\n  }\n\n  .col-md-1 {\n    width: 8.33333333%;\n  }\n\n  .col-md-pull-12 {\n    right: 100%;\n  }\n\n  .col-md-pull-11 {\n    right: 91.66666667%;\n  }\n\n  .col-md-pull-10 {\n    right: 83.33333333%;\n  }\n\n  .col-md-pull-9 {\n    right: 75%;\n  }\n\n  .col-md-pull-8 {\n    right: 66.66666667%;\n  }\n\n  .col-md-pull-7 {\n    right: 58.33333333%;\n  }\n\n  .col-md-pull-6 {\n    right: 50%;\n  }\n\n  .col-md-pull-5 {\n    right: 41.66666667%;\n  }\n\n  .col-md-pull-4 {\n    right: 33.33333333%;\n  }\n\n  .col-md-pull-3 {\n    right: 25%;\n  }\n\n  .col-md-pull-2 {\n    right: 16.66666667%;\n  }\n\n  .col-md-pull-1 {\n    right: 8.33333333%;\n  }\n\n  .col-md-pull-0 {\n    right: auto;\n  }\n\n  .col-md-push-12 {\n    left: 100%;\n  }\n\n  .col-md-push-11 {\n    left: 91.66666667%;\n  }\n\n  .col-md-push-10 {\n    left: 83.33333333%;\n  }\n\n  .col-md-push-9 {\n    left: 75%;\n  }\n\n  .col-md-push-8 {\n    left: 66.66666667%;\n  }\n\n  .col-md-push-7 {\n    left: 58.33333333%;\n  }\n\n  .col-md-push-6 {\n    left: 50%;\n  }\n\n  .col-md-push-5 {\n    left: 41.66666667%;\n  }\n\n  .col-md-push-4 {\n    left: 33.33333333%;\n  }\n\n  .col-md-push-3 {\n    left: 25%;\n  }\n\n  .col-md-push-2 {\n    left: 16.66666667%;\n  }\n\n  .col-md-push-1 {\n    left: 8.33333333%;\n  }\n\n  .col-md-push-0 {\n    left: auto;\n  }\n\n  .col-md-offset-12 {\n    margin-left: 100%;\n  }\n\n  .col-md-offset-11 {\n    margin-left: 91.66666667%;\n  }\n\n  .col-md-offset-10 {\n    margin-left: 83.33333333%;\n  }\n\n  .col-md-offset-9 {\n    margin-left: 75%;\n  }\n\n  .col-md-offset-8 {\n    margin-left: 66.66666667%;\n  }\n\n  .col-md-offset-7 {\n    margin-left: 58.33333333%;\n  }\n\n  .col-md-offset-6 {\n    margin-left: 50%;\n  }\n\n  .col-md-offset-5 {\n    margin-left: 41.66666667%;\n  }\n\n  .col-md-offset-4 {\n    margin-left: 33.33333333%;\n  }\n\n  .col-md-offset-3 {\n    margin-left: 25%;\n  }\n\n  .col-md-offset-2 {\n    margin-left: 16.66666667%;\n  }\n\n  .col-md-offset-1 {\n    margin-left: 8.33333333%;\n  }\n\n  .col-md-offset-0 {\n    margin-left: 0;\n  }\n}\n\n#footer {\n  background-color: white !important;\n  color: #c0c0c0;\n}\n\n#logo {\n  height: auto;\n}\n\n#logo img {\n  top: unset !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  /***/
  function srcAppProfileInvoiceInvoiceComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var InvoiceComponent = /*#__PURE__*/function () {
      function InvoiceComponent(store, router, injector) {
      ...
      _createClass(InvoiceComponent, [{
        ...
        value: function getSubscribeInfo() {
          var _this7 = this;

          this.store.select(_profile_state_profile_selector__WEBPACK_IMPORTED_MODULE_3__["subscribeInfo"]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeWhile"])(function () {
            return _this7.isSubscribing;
          })).subscribe(function (obj) {
            if (obj) {
              _this7.fee = obj.subscribePrice;
              _this7.vat = 0.2 * obj.subscribePrice;
              _this7.total = _this7.fee + _this7.vat;
              _this7.subscriptionType = obj.subscriptionPlan; // this.id = obj.id;
        ...
        value: function goBack() {
          ...
          var routerService = this.injector.get(_angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"]);
          var ngZone = this.injector.get(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgZone"]);
          ngZone.run(function () {
            _this9.router.navigate(['/client/home']);
          });
        }
      }, {
        key: "ngOnDestroy",
    ...
    InvoiceComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/profile/invoice/invoice.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./invoice.component.scss */
      "./src/app/profile/invoice/invoice.component.scss"))["default"]]
    })], InvoiceComponent);
    /***/
  },

  /***/
  "./src/app/profile/sms-extension-popup/sms-extension-popup.component.scss":
  /*!********************************************************************************!*\
    !*** ./src/app/profile/sms-extension-popup/sms-extension-popup.component.scss ***!
    \********************************************************************************/
  ...
  /***/
  function srcAppProfileSmsExtensionPopupSmsExtensionPopupComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = ".mat-dialog-container {\n  padding: 0px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },

  /***/
  "./src/app/profile/sms-extension-popup/sms-extension-popup.component.ts":
  /*!******************************************************************************!*\
    !*** ./src/app/profile/sms-extension-popup/sms-extension-popup.component.ts ***!
    \******************************************************************************/

  /*! exports provided: SmsExtensionPopupComponent */

  /***/
  function srcAppProfileSmsExtensionPopupSmsExtensionPopupComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SmsExtensionPopupComponent", function () {
      return SmsExtensionPopupComponent;
    });
    /* harmony import */
    ...
    var SmsExtensionPopupComponent = /*#__PURE__*/function () {
      function SmsExtensionPopupComponent(dialog, alertService, store, router, data) {
        _classCallCheck(this, SmsExtensionPopupComponent);
      ...
      _createClass(SmsExtensionPopupComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "goToCheckout",
        value: function goToCheckout(price, Subscibetype) {
          var _this10 = this;

          this.alertService.successCounterup('Online SMS Services', 'Proceed to check out page !!!');
          setTimeout(function () {
            _this10.router.navigate(['/profile/checkout']);
          }, 2100);
          this.dialog.closeAll();
          this.store.dispatch(_profile_state_profile_actions__WEBPACK_IMPORTED_MODULE_4__["ProfileSubscriptionPrice"]({
            id: null,
            price: price,
            subscriptionPlan: Subscibetype
          }));
        }
      }]);
    ...
    SmsExtensionPopupComponent.ctorParameters = function () {
      return [{
        type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialog"]
      }, {
        type: src_app_services_alert_service__WEBPACK_IMPORTED_MODULE_3__["AlertService"]
    ...
    SmsExtensionPopupComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'sms-sms-extension-popup',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./sms-extension-popup.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/profile/sms-extension-popup/sms-extension-popup.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./sms-extension-popup.component.scss */
      "./src/app/profile/sms-extension-popup/sms-extension-popup.component.scss"))["default"]]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__param"](4, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"])(_angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"]))], SmsExtensionPopupComponent);
    /***/
  },
  ...
  /*! exports provided: ProfileActionTypes, ProfileGetUserInfo, ProfileGetUserSuccess, ProfileGetFriendList, ProfileGetFriendListSuccess, ProfileGetSubscribeService, ProfileGetSubscribeServiceSuccess, ProfileSubscriptionPrice */
  ...
  function srcAppProfileStateProfileActionsTs(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "ProfileSubscriptionPrice", function () {
      return ProfileSubscriptionPrice;
    });
    /* harmony import */
    ...
    (function (ProfileActionTypes) {
      ...
      ProfileActionTypes["ProfileSubscriptionPrice"] = "[Profile] Dispatch Price";
    ...
    var ProfileSubscriptionPrice = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])(ProfileActionTypes.ProfileSubscriptionPrice, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
    /***/
  },
  ...
  /*! exports provided: profileFeature, userInfo, friendList, subscribeList, subscribeInfo */
  ...
  function srcAppProfileStateProfileSelectorTs(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "subscribeInfo", function () {
    ...
    var subscribeInfo = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(profileFeature, function (state) {
  ...
  /***/
  "./src/app/profile/subscription-popup/subscription-popup.component.scss":
  /*!******************************************************************************!*\
    !*** ./src/app/profile/subscription-popup/subscription-popup.component.scss ***!
    \******************************************************************************/
  ...
  /***/
  function srcAppProfileSubscriptionPopupSubscriptionPopupComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = ".pricing-plans-container {\n  margin-top: 40px;\n}\n\n/* .paypal_section {\n  position: absolute;\n  right: 0;\n  bottom: 0;\n} */\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppProfileSubscriptionPopupSubscriptionPopupComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var SubscriptionPopupComponent = /*#__PURE__*/function () {
      function SubscriptionPopupComponent(dialog, store, alertService, router, data) {
      ...
      _createClass(SubscriptionPopupComponent, [{
        ...
        value: function goToCheckout(price, Subscibetype) {
          ...
          this.dialog.closeAll();
          setTimeout(function () {
            _this11.router.navigate(['/profile/checkout']);
          }, 2100);
          this.store.dispatch(_profile_state_profile_actions__WEBPACK_IMPORTED_MODULE_4__["ProfileSubscriptionPrice"]({
            id: this.id,
            price: price,
    ...
    SubscriptionPopupComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./subscription-popup.component.scss */
      "./src/app/profile/subscription-popup/subscription-popup.component.scss"))["default"]]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__param"](4, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"])(_angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"]))], SubscriptionPopupComponent);
    /***/
  },
  ...
  function srcAppServicesAdminServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AdminService = /*#__PURE__*/function () {
      ...
      _createClass(AdminService, [{
        ...
        key: "getRecommendFriendPublic",
        value: function getRecommendFriendPublic() {
          return this.http.get("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl, "/api/Friend/GetRecommendFriendPublic"));
        }
      }, {
        key: "setHeader",
        ...
        key: "smsExtendServices",
        value: function smsExtendServices(money) {
          return this.http.get("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl, "/api/Sms/Charge?money=").concat(money));
        }
      }, {
  ...
  function srcAppStateAppReducerTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _counterReducer = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createReducer"])(initialState);
