...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["profile-profile-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppProfileCheckoutCheckoutComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppLayoutProfileLayoutProfileLayoutComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ProfileLayoutComponent = /*#__PURE__*/function () {
      function ProfileLayoutComponent(router, activatedRoute) {
      ...
      _createClass(ProfileLayoutComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {// this.isLayout = true;
    ...
    ProfileLayoutComponent.ctorParameters = function () {
      return [{
  ...
  /***/
  function srcAppProfileCheckoutCheckoutComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppProfileCheckoutCheckoutComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var CheckoutComponent = /*#__PURE__*/function () {
      function CheckoutComponent(store, adminService, alertService, router, spinner // private dialogRef: MatDialogRef<SubscriptionPopupComponent>, // Import Login Dialog Component to close
      ) {
      ...
      _createClass(CheckoutComponent, [{
        ...
        value: function getSubscribeInfo() {
          ...
          this.store.select(_profile_state_profile_selector__WEBPACK_IMPORTED_MODULE_3__["subscribeInfo"]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["takeWhile"])(function () {
            return _this2.isSubscribing;
          })).subscribe(function (obj) {
            if (obj) {
              _this2.fee = obj.subscribePrice;
              _this2.vat = 0.2 * obj.subscribePrice;
              _this2.total = _this2.fee + _this2.vat;
              _this2.subscriptionType = obj.subscriptionPlan;
              _this2.id = obj.id;
            ...
            createOrder: function createOrder(data, actions) {
              return actions.order.create({
                purchase_units: [{
                  ...
                  amount: {
                    currency_code: 'USD',
                    value: _this3.total ? _this3.total : 1
                  }
                }]
              });
            },
                    ...
                    switch (_context.prev = _context.next) {
                      ...
                      case 2:
                        ...
                        setTimeout(function () {
                          ...
                          if (_this4.id) {
                            _this4.adminService.subscribeServices(_this4.id, length).subscribe(function (data) {
                              if (data) {
                                _this4.spinner.hide();

                                _this4.alertService.successCounterup('Online SMS Services', 'Subscription Success !!!');

                                setTimeout(function () {
                                  _this4.router.navigate(['/invoice']);
                                }, 2100);
                              }
                            });
                          } else {
                            _this4.adminService.smsExtendServices(_this4.total).subscribe(function (data) {
                              if (data) {
                                _this4.alertService.successCounterup('Online SMS Services', 'SMS Extend Success !!!');
    ...
    CheckoutComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/profile/checkout/checkout.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./checkout.component.scss */
      "./src/app/profile/checkout/checkout.component.scss"))["default"]]
    })], CheckoutComponent);
    /***/
  },
  ...
  function srcAppProfileFriendLayoutFriendLayoutComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var FriendLayoutComponent = /*#__PURE__*/function () {
      function FriendLayoutComponent(adminService, store, alertService, spinner) {
      ...
      _createClass(FriendLayoutComponent, [{
        ...
        value: function getUserInfo() {
          ...
          this.store.select(_profile_state_profile_selector__WEBPACK_IMPORTED_MODULE_4__["userInfo"]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["takeWhile"])(function () {
            return _this5.isSubscribing;
          })).subscribe(function (data) {
            // console.log('a', data);
            if (data) {
              _this5.userName = data.Name; // this.userName = data.Avatar;
            }
          });
        }
      }, {
        ...
        value: function getSuggestionFriend() {
          ...
          this.adminService.getRecommendFriend().subscribe(function (friends) {
            ...
            if (friends) {
              _this6.totalFriend = friends.length;
              _this6.datasource = friends;
        ...
        value: function getRequestFriend() {
          ...
          this.adminService.getFriendList(true, '', true, 1, 10).subscribe(function (friends) {
            ...
            if (friends) {
              _this7.totalFriend = friends.length;
              _this7.datasource = friends;
        ...
        value: function getReceiveFriend() {
          ...
          this.adminService.getFriendList(false, '', true, 1, 10).subscribe(function (friends) {
            ...
            if (friends) {
              _this8.totalFriend = friends.length;
              _this8.datasource = friends;
        ...
        value: function getListFriend() {
          ...
          this.store.select(_profile_state_profile_selector__WEBPACK_IMPORTED_MODULE_4__["friendList"]).subscribe(function (friends) {
            ...
            if (friends) {
              _this9.totalFriend = friends.length;
              _this9.datasource = friends;
        ...
        value: function addFriend(id) {
          ...
          this.adminService.sendFriendRequest(body).subscribe(function (res) {
            ...
            if (res) {
              _this10.alertService.success('Friend request successfully sent.');

              _this10.getSuggestionFriend();
            }
          });
        }
      }, {
        ...
        value: function approveFriend(id) {
          ...
          this.adminService.approveFriend(body).subscribe(function (res) {
            ...
            if (res) {
              _this11.alertService.success('Approve friend success.');

              _this11.getReceiveFriend(); // Reset datasource
        ...
        value: function removeFriend(id) {
          ...
          this.adminService.removeFriend(body).subscribe(function (res) {
            ...
            if (res) {
              _this12.alertService.success('Delete friend success.');

              _this12.getListFriend(); // Reset datasource
      ...
      _createClass(PostAnonymousMsgComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.store.select(_profile_state_profile_selector__WEBPACK_IMPORTED_MODULE_8__["friendList"]).subscribe(function (friends) {
            ...
            if (friends && friends.length > 0) {
              _this13.currentFriendArray = friends;
              _this13.currentFriendArray = _this13.currentFriendArray.filter(function (x) {
                return x.Id == _this13.friendId;
              });
              _this13.currentFriend = _this13.currentFriendArray[0];
              console.log(_this13.currentFriend);
            }
          });
          ...
          if (this.postAnonymousMsgForm.invalid) {
            ...
            this.adminService.sendAnonymousMsg(body).pipe().subscribe(function (res) {
              if (res) {
                ...
                _this14.showMsg('Message', 'Message sent success !!!');
  ...
  function srcAppProfileProfileModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _layout_profile_layout_profile_layout_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
    /*! ../layout/profile-layout/profile-layout.component */
    "./src/app/layout/profile-layout/profile-layout.component.ts");
    /* harmony import */


    var _layout_header_admin_header_admin_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
    /*! ../layout/header-admin/header-admin.component */
    "./src/app/layout/header-admin/header-admin.component.ts");
    /* harmony import */


    var _layout_sidebar_admin_sidebar_admin_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(
    /*! ../layout/sidebar-admin/sidebar-admin.component */
    "./src/app/layout/sidebar-admin/sidebar-admin.component.ts");
    /* harmony import */


    var _layout_footer_admin_footer_admin_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(
  ...
  function srcAppProfileProfileRouteTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _checkout_checkout_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ./checkout/checkout.component */
    "./src/app/profile/checkout/checkout.component.ts");
    /* harmony import */


    var _layout_profile_layout_profile_layout_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ../layout/profile-layout/profile-layout.component */
    "./src/app/layout/profile-layout/profile-layout.component.ts");
    ...
    var routes = [{
      ...
      children: [{
        ...
        path: 'checkout',
        component: _checkout_checkout_component__WEBPACK_IMPORTED_MODULE_12__["CheckoutComponent"]
      }, {
        path: 'setting',
  ...
  function srcAppProfileSettingsSettingsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _sms_extension_popup_sms_extension_popup_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ../sms-extension-popup/sms-extension-popup.component */
    "./src/app/profile/sms-extension-popup/sms-extension-popup.component.ts");

    var SettingsComponent = /*#__PURE__*/function () {
      function SettingsComponent(store, formBuilder, storage, authenticationService, adminService, alertService, dialog) {
      ...
      _createClass(SettingsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.store.select(_profile_state_profile_selector__WEBPACK_IMPORTED_MODULE_3__["userInfo"]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeWhile"])(function () {
            return _this15.isSubscribing;
          })).subscribe(function (data) {
            console.log(data);

            if (data) {
              _this15.name = data.Name;
              _this15.avatar = data.Avatar;
              _this15.accountBalance = data.Balance;
            }
          });
        }
      }, {
        ...
        value: function onSubmit() {
          ...
          if (this.settingForm.invalid) {
            ...
            task.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["finalize"])(function () {
              _this16.downloadURL = fileRef.getDownloadURL();

              _this16.downloadURL.subscribe(function (url) {
                if (url) {
                  _this16.fb = url;
                  var body = {
                    Name: _this16.name,
                  ...
                  _this16.adminService.editProfile(body).subscribe(function (data) {
                    _this16.alertService.success('Update Profile success.');

                    _this16.store.dispatch(_profile_state_profile_actions__WEBPACK_IMPORTED_MODULE_9__["ProfileGetUserInfo"]());
        ...
        value: function openDialog() {
          var dialogRef = this.dialog.open(_sms_extension_popup_sms_extension_popup_component__WEBPACK_IMPORTED_MODULE_12__["SmsExtensionPopupComponent"], {
            height: '630px',
            width: '1050px'
          });
  ...
  function srcAppProfileStateProfileEffectsTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ProfileEffects = function ProfileEffects(actions$, adminService) {
      ...
      this.getUserInfo$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_3__["createEffect"])(function () {
        return _this17.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_3__["ofType"])(_profile_actions__WEBPACK_IMPORTED_MODULE_6__["ProfileActionTypes"].ProfileGetUserInfo), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["mergeMap"])(function () {
          return _this17.adminService.getUserInfo().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (info) {
      ...
      this.getFriendList$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_3__["createEffect"])(function () {
        return _this17.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_3__["ofType"])(_profile_actions__WEBPACK_IMPORTED_MODULE_6__["ProfileActionTypes"].ProfileGetFriendList), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["mergeMap"])(function () {
          return _this17.adminService.getFriendList(null, '', true, 1, 10).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (friendList) {
      ...
      this.getsubscribeList$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_3__["createEffect"])(function () {
        return _this17.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_3__["ofType"])(_profile_actions__WEBPACK_IMPORTED_MODULE_6__["ProfileGetSubscribeService"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["mergeMap"])(function (obj) {
          return _this17.adminService.getAllServices(obj.status).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function (subscribeList) {
            subscribeList.forEach(function (x) {
              x.active = true;
            });

            _this17.adminService.getAllServices(true).subscribe(function (res) {
              if (res) {
                if (res.length > 0) {
  ...
  function srcAppProfileStateProfileReducerTs(module, __webpack_exports__, __webpack_require__) {
    ...
    }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_profile_actions__WEBPACK_IMPORTED_MODULE_2__["ProfileSubscriptionPrice"], function (state, _ref4) {
      var id = _ref4.id,
          price = _ref4.price,
          subscriptionPlan = _ref4.subscriptionPlan;
      return Object.assign({}, state, {
        subscribeInfo: {
          id: id,
  ...
  function srcAppProfileSubscriptionListSubscriptionListComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _profile_state_profile_actions__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../../profile/state/profile.actions */
    "./src/app/profile/state/profile.actions.ts");
    /* harmony import */
    ...
    var _subscription_popup_subscription_popup_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    ...
    var SubscriptionListComponent = /*#__PURE__*/function () {
      function SubscriptionListComponent(adminService, alertService, store, dialog, spinner) {
      ...
      _createClass(SubscriptionListComponent, [{
        ...
        value: function getSubscriptionList() {
          ...
          this.spinner.show();
          this.store.dispatch(_profile_state_profile_actions__WEBPACK_IMPORTED_MODULE_6__["ProfileGetSubscribeService"]({
            status: null
          }));
          this.store.select(_profile_state_profile_selector__WEBPACK_IMPORTED_MODULE_5__["subscribeList"]).subscribe(function (list) {
            console.log('subscription list', list);

            if (list) {
              _this18.subscriptionList = list;
        ...
        value: function unsubscribeService(id) {
          ...
          this.adminService.unSubscribeServices(id).subscribe(function (res) {
            ...
            _this19.store.dispatch(_profile_state_profile_actions__WEBPACK_IMPORTED_MODULE_6__["ProfileGetSubscribeService"]({
              status: null
            }));

            _this19.alertService.successCounterup('Subscription', 'UnSubscription Success !!!');
          });
        }
      }, {
        key: "openDialog",
        value: function openDialog(itemPrice, itemId) {
          var dialogRef = this.dialog.open(_subscription_popup_subscription_popup_component__WEBPACK_IMPORTED_MODULE_8__["SubscriptionPopupComponent"], {
            height: '600px',
            width: '1050px',
            data: {
              price: itemPrice,
