...
let FriendLayoutComponent = class FriendLayoutComponent {
    constructor(adminService, store, alertService) {
    ...
    getUserInfo() {
        this.store.select(_profile_state_profile_selector__WEBPACK_IMPORTED_MODULE_4__["userInfo"]).subscribe(data => {
            // console.log('a', data);
            if (data) {
...
ProfileModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            ...
            _ngrx_store__WEBPACK_IMPORTED_MODULE_11__["StoreModule"].forFeature('profile', _state_profile_reducer__WEBPACK_IMPORTED_MODULE_12__["counterReducer"]),
...
let SettingsComponent = class SettingsComponent {
    constructor(store, formBuilder, storage, authenticationService, adminService, alertService) {
        this.store = store;
        this.formBuilder = formBuilder;
...
SettingsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./settings.component.css */ "./src/app/profile/settings/settings.component.css")).default]
    })
], SettingsComponent);
